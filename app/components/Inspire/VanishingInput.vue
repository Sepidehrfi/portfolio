<template>
	...
	>
		...
		<canvas
			ref="canvasRef"
			:class="[
				'pointer-events-none absolute left-2 top-[20%] origin-top-left scale-50 pr-20 text-base invert dark:invert-0 sm:left-8',
		...
		<input
			...
			:disabled="animating"
			type="text"
			class="relative z-50 size-full rounded-full border-none bg-transparent pl-4 pr-20 text-sm text-black focus:outline-none focus:ring-0 dark:text-white sm:pl-10 sm:text-base"
		...
		<div class="pointer-events-none absolute inset-0 flex items-center rounded-full">
			...
			>
				<p
					...
					class="w-[calc(100%-2rem)] truncate pl-4 text-left text-sm font-normal text-neutral-500 dark:text-zinc-500 sm:pl-10 sm:text-base"
				>
